...
<template>
  <button
    class="
      h-40 w-full rounded hover:shadow-md transition hover:scale-105
      relative border-2 border-slate-300 dark:border-slate-600
  ...
  >
    ...
    <!-- Card back -->
    <div class="card-face absolute inset-0 pointer-events-none flex flex-col items-center justify-center">
