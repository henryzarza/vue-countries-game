...
const { nameId, label, placeholder } = defineProps<{
  nameId: string,
  label: string,
  placeholder?: string
}>()
...
<template>
  ...
  <textarea
    ...
    class="
      ...
      ring-1 ring-inset ring-zinc-300 placeholder:text-zinc-400 focus:ring-2 focus:ring-inset
      focus:ring-violet-600 dark:focus:ring-emerald-600 bg-zinc-50 dark:bg-zinc-800
      dark:placeholder:text-zinc-500 dark:ring-zinc-700 outline-none min-h-[5rem]
    "
  ></textarea>
</template>
