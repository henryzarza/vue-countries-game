...
const { data, showName, continentCode } = defineProps<{
  data: Country
  showName: boolean
...
<template>
  <div
    class="max-w-[10rem] rounded hover:shadow-md transition hover:scale-105 p-2 border-2 border-solid border-slate-200 dark:border-slate-600 cursor-grab bg-slate-100 dark:bg-slate-900 flex flex-col text-center"
    draggable="true"
